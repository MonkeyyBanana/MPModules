...
public class configManager {
	...
	public void loadConfig() {
	    ...
	    try {
	    	...
	    	System.out.println("[MonkeyModules-DEBUG] Successfully Loaded Config!");
	    } catch (Exception e) {
			e.printStackTrace();
			System.out.println(ChatColor.RED + "[MonkeyModules-DEBUG] Bruh What You Do?");
	    }
	}
	
	public String getString(String key) {
		if (!Main.getConfig().contains(key)) {
			System.out.println("[MonkeyModules-DEBUG] Could Not Locate " + key + " In The 'config.yml' Inside Of The " + Main.getDescription().getName() + " Folder! (DELETE THE CURRENT ONE TO RESET TO DEFAULT!)");
